...
export const Conditions: { [cond: string]: Condition } = Object.freeze({
  accumulatetime: immediate({
    filterGte(
      ...
      return [
        regions.rmap((r) => r.intersect(allowedRegion)),
        (s: RaceState) => s.accumulatetime.t >= t,
  ...
  is_activate_any_skill: immediate({
    filterEq(
      ...
      return [regions, (s: RaceState) => s.activateCountLastFrame > 0] as [
        RegionList,
        DynamicCondition,
      ];
    },
  ...
  is_temptation: immediate({
    filterEq(
      ...
      return [regions, (s: RaceState) => +s.isKakari == b] as [
        RegionList,
        DynamicCondition,
      ];
    },
  ...
  temptation_count: immediate({
    filterEq(
      ...
      return [regions, (s: RaceState) => s.temptationCount == n] as [
        RegionList,
        DynamicCondition,
      ];
    },
