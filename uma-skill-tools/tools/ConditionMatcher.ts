...
function condMatcher(cond: Condition | CmpOperator, node: Operator) {
	...
	return node !== null && (condMatcher(cond, node.left) || condMatcher(cond, node.right));
}
